...
const schemaEditar = schemaCrear
  .omit({ nombreUsuario: true, contrasena: true, numeroCarne: true, cui: true })
  .extend({
    inscrito: z.boolean(),
...
export default function EstudianteFormPage() {
  ...
  const { data: tiposSangre = [] } = useQuery({
    queryKey: ["catalogo", "tipo-sangre"],
    queryFn: () => listarCatalogo("tipo-sangre"),
  });
  ...
  const editarMut = useMutation({
    mutationFn: (dto: FormEditar) =>
      actualizarEstudiante(Number(id), {
        ...dto,
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-3">
        <button
          onClick={() =>
            navigate(esEdicion ? `/estudiantes/${id}` : "/estudiantes")
          }
        ...
        <div>
          ...
          <p className="text-xs mt-0.5" style={{ color: "#475569" }}>
            {esEdicion
              ...
              : "Completa los datos para registrar al estudiante"}
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              >
                <input
                  ...
                  style={inputStyle(
                    !!(errors as Record<string, unknown>).nombreUsuario,
                  )}
              ...
              >
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
                  style={inputStyle(
                    !!(errors as Record<string, unknown>).contrasena,
                  )}
                  {...register("contrasena")}
                />
              </FormField>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {!esEdicion && (
              <FormField
                ...
                error={
                  (errors as Record<string, { message?: string }>).numeroCarne
                    ?.message
                }
              >
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1 font-mono"
                  style={inputStyle(
                    !!(errors as Record<string, unknown>).numeroCarne,
                  )}
            ...
            <FormField
              label="Carrera"
              error={
                (errors as Record<string, { message?: string }>).carreraId
                  ?.message
              }
            >
              <select
                className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
                style={inputStyle(
                  !!(errors as Record<string, unknown>).carreraId,
                )}
                {...register("carreraId")}
              >
            ...
            <FormField
              ...
              error={
                (errors as Record<string, { message?: string }>).anioIngreso
                  ?.message
              }
            >
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
                style={inputStyle(
                  !!(errors as Record<string, unknown>).anioIngreso,
                )}
        ...
        <FormSeccion titulo="Datos personales">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <FormField
              label="Nombres"
              error={
                (errors as Record<string, { message?: string }>).nombres
                  ?.message
              }
            >
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
                style={inputStyle(
                  !!(errors as Record<string, unknown>).nombres,
                )}
                {...register("nombres")}
              />
            </FormField>
            <FormField
              label="Apellidos"
              error={
                (errors as Record<string, { message?: string }>).apellidos
                  ?.message
              }
            >
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
                style={inputStyle(
                  !!(errors as Record<string, unknown>).apellidos,
                )}
                {...register("apellidos")}
              />
            </FormField>
            {!esEdicion && (
              <FormField
                label="CUI"
                error={
                  (errors as Record<string, { message?: string }>).cui?.message
                }
              >
                <input
                  type="text"
                  ...
                  maxLength={13}
                  className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1 font-mono"
                  style={inputStyle(!!(errors as Record<string, unknown>).cui)}
                  {...register("cui")}
                />
              </FormField>
            )}
            <FormField
              ...
              error={
                (errors as Record<string, { message?: string }>).fechaNacimiento
                  ?.message
              }
            >
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
                style={inputStyle(
                  !!(errors as Record<string, unknown>).fechaNacimiento,
                )}
            ...
            <FormField
              label="Género"
              error={
                (errors as Record<string, { message?: string }>).genero?.message
              }
            >
              <select
                className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
                style={inputStyle(!!(errors as Record<string, unknown>).genero)}
                {...register("genero")}
              >
            ...
            <FormField
              label="Dirección"
              error={
                (errors as Record<string, { message?: string }>).direccion
                  ?.message
              }
            >
              <input
                type="text"
                placeholder="Zona 1, Chiquimula"
                className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
                style={inputStyle(
                  !!(errors as Record<string, unknown>).direccion,
                )}
                {...register("direccion")}
              />
            </FormField>
        ...
        <FormSeccion titulo="Correos">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <FormField
              ...
              error={
                (errors as Record<string, { message?: string }>)
                  .correoInstitucional?.message
              }
            >
              <input
                type="email"
                placeholder="juan@cunori.edu.gt"
                className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
                style={inputStyle(
                  !!(errors as Record<string, unknown>).correoInstitucional,
                )}
            ...
            <FormField
              ...
              error={
                (errors as Record<string, { message?: string }>).correoPersonal
                  ?.message
              }
            >
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
                style={inputStyle(
                  !!(errors as Record<string, unknown>).correoPersonal,
                )}
        ...
        <FormSeccion titulo="Fotografía">
          <FormField
            ...
            error={
              (errors as Record<string, { message?: string }>).rutaFotografia
                ?.message
            }
          >
            <input
              ...
              className="w-full px-4 py-2.5 rounded-lg text-sm outline-none focus:ring-1"
              style={inputStyle(
                !!(errors as Record<string, unknown>).rutaFotografia,
              )}
