...
import { buscarEstudiantes, obtenerMiExpediente } from "@/api/estudiantes";
...
export default function JustificacionesPage() {
  ...
  const estudianteIdPropio = tieneRol("ESTUDIANTE")
    ? miExpediente?.id
    : undefined;
  ...
  const { data: resultadosBusqueda = [] } = useQuery({
    ...
    enabled:
      tieneRol("ADMIN", "COORDINADOR") && terminoBusqueda.trim().length >= 2,
  });
      ...
      {tieneRol("ADMIN", "COORDINADOR") && (
        ...
        >
          ...
          <select
            value={estado}
            onChange={(e) =>
              setEstado(e.target.value as EstadoJustificacion | "")
            }
            disabled={!!estudianteFiltro}
          ...
          <div className="relative" style={{ minWidth: 220 }}>
            {estudianteFiltro ? (
              ...
              <div
                ...
                style={{
                  ...inputStyle,
                  border: "1px solid rgba(244,233,205,0.3)",
                }}
              >
                ...
                {justificaciones.map((j, i) => (
                  ...
                  >
                    ...
                    <td
                      ...
                      style={{ color: "#475569" }}
                    >
                      {format(new Date(j.fechaPresentacion), "dd MMM yyyy", {
                        locale: es,
                      })}
                    </td>
                    <td
