 ...
 */
export default function ModalCarrera({ item, onGuardar, onCerrar, cargando }: Props) {
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit(onGuardar)} className="px-6 py-5 space-y-4">
          ...
          {[
            { field: 'nombre' as const, label: 'Nombre', placeholder: 'Ingeniería en Sistemas' },
            { field: 'codigo' as const, label: 'Código', placeholder: 'ISC' },
            { field: 'nombreCoordinador' as const, label: 'Coordinador', placeholder: 'Nombre del coordinador' },
            ...
            <div key={field}>
              ...
              <input
                ...
                style={{
                  background: '#0f172a',
                  border: errors[field] ? '1px solid #f87171' : '1px solid #334155',
                  color: '#f1f5f9',
