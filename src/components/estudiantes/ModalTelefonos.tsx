...
export default function ModalTelefonos({ estudianteId, telefonosActuales, onClose }: Props) {
  ...
  const mut = useMutation({
    mutationFn: (data: TelefonoInput[]) => actualizarTelefonos(estudianteId, data),
    onSuccess: () => {
  ...
  const agregar = () => setLista(p => [...p, { numero: '', tipo: 'CELULAR' }])
