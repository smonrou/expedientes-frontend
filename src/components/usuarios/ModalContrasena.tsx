 ...
 */
export default function ModalContrasena({ nombreUsuario, onGuardar, onCerrar, cargando }: Props) {
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="px-6 py-5 space-y-4">
          {[
            { field: 'nuevaContrasena' as const, label: 'Nueva contraseña', placeholder: 'Mínimo 6 caracteres' },
            { field: 'confirmar' as const, label: 'Confirmar contraseña', placeholder: 'Repite la contraseña' },
