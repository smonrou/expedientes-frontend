 ...
 */
export async function crearUsuario(dto: UsuarioCreateRequest): Promise<UsuarioResponse> {
 ...
 */
export async function actualizarUsuario(id: number, dto: UsuarioUpdateRequest): Promise<UsuarioResponse> {
 ...
 */
export async function cambiarContrasena(id: number, dto: CambioContrasenaRequest): Promise<void> {
